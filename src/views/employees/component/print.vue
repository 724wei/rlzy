    ...
    <div class="app-container">
      <el-card>
        ...
        <el-row type="flex" justify="end">
          <el-button v-print="'#printIt'" type="primary">打印</el-button>
        </el-row>
        <div v-if="type === 'personal'" id="printIt">
...
import { getJobDetail, getPersonalDetail } from '@/api/employee'
export default {
  data() {
    return {
      formData: {},
